...
public class gramRDFParser extends Parser {
    ...
    public String[] getTokenNames() {
        return gramRDFParser.tokenNames;
    }
    ...
    public final void tabla() throws RecognitionException {
        ...
        try {
            ...
            // .\\gramRDF.g:22:2: TABLA ID INICIO ( campo )+ FIN
            {
                ...
                salida.append("<!-- Clase: " + (ID2 != null ? ID2.getText() : null) + " -->\n");
    ...
    public final void campo() throws RecognitionException {
        ...
        try {
            ...
            // .\\gramRDF.g:32:2: ID (t= NUMERICO |t= ALFABETICO |t= FECHA )
            {
                ...
                salida.append("    <rdfs:domain rdf:resource=\"#" + (ID3 != null ? ID3.getText() : null) + "\"/>\n");

// Asignar el rango correcto según el tipo.
                if ((t != null ? t.getText() : null) != null && t.getText().compareTo("letras") == 0) {
                    salida.append("    <rdfs:range rdf:resource=\"&xsd;string\"/>\n");
                } else if ((t != null ? t.getText() : null) != null && t.getText().compareTo("numeros") == 0) {
                    salida.append("    <rdfs:range rdf:resource=\"&xsd;integer\"/>\n");
                } else if ((t != null ? t.getText() : null) != null && t.getText().compareTo("fecha") == 0) {
