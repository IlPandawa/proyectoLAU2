// $ANTLR 3.5.2 .\\T2.g 2024-11-15 11:52:30
...
public class T2Lexer extends Lexer {
	...
	@Override public String getGrammarFileName() { return ".\\T2.g"; }
	...
	public final void mID() throws RecognitionException {
		try {
			int _type = ID;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// .\\T2.g:47:3: ( ( 'a' .. 'z' | 'A' .. 'Z' | '_' ) ( 'a' .. 'z' | 'A' .. 'Z' | '0' .. '9' | '_' )* )
			// .\\T2.g:47:5: ( 'a' .. 'z' | 'A' .. 'Z' | '_' ) ( 'a' .. 'z' | 'A' .. 'Z' | '0' .. '9' | '_' )*
			{
	...
	public void mTokens() throws RecognitionException {
		// .\\T2.g:1:8: ( CERRAR | NUMERICO | ALFABETICO | FECHA | TABLA | INICIO | FIN | USAR | CREAR | ID | WS )
		int alt3=11;
		switch ( input.LA(1) ) {
		case 'c':
			{
